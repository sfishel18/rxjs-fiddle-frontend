...
declare module 'recoil' {
  function useRecoilState<T>(recoilState: RecoilState<T>): MemoizedStateTuple<T>;
  function useRecoilValue<T>(recoilState: RecoilState<T>): MemoizedStateTuple<T>[0];
  function useSetRecoilState<T>(recoilState: RecoilState<T>): MemoizedStateTuple<T>[1];
}
...
declare global {
  ...
  namespace React {
    ...
    function useCallback<T extends (...args: any) => any>(cb: T, deps: MemoizedDependencyList): Memoized<T>;
    function useEffect<T extends 'strict'>(effect: () => (void | (() => void | undefined)), deps: MemoizedDependencyList): void;
